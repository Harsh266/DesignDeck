        ...
        <div className="grid gap-4">
          {mediaItems.map((item, index) => (
            <div key={index} className="w-full max-w-2xl mx-auto relative">
              ...
              {index === 0 && (
                <div className="fixed z-[2] top-[80%] left-[50%] transform -translate-x-1/2 w-[80%] max-w-md p-3 bg-white shadow-lg rounded-lg flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Link to="/profilepage">
                      <button className="bg-gray-200 rounded-full w-8 h-8 cursor-pointer">
