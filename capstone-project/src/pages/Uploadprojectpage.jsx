                ...
                {showImagePopup && (
                    <div className="fixed inset-0 bg-transparent backdrop-blur-sm flex justify-center items-center mt-12">
                        <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full relative h-[95%] flex flex-col">
                            ...
                            {/* Upload Box */}
                            <label htmlFor="fileInput" className="mt-3 border border-2 border-[#ED9E29] bg-[#FDE8CB] p-6 text-center rounded-lg cursor-pointer ">
                            ...
                            <div className="mt-3">
                                ...
                                <input type="text" placeholder="Enter your project name" className="w-full p-2 border border-[#9E9E9E] rounded mt-1 outline-none" />
                            </div>

                            {/* Project Description */}
                            <div className="mt-3">
                                <label className="block font-medium text-[16px]">Project Description</label>
                                <input type="text" placeholder="Enter your project description" className="w-full p-2 border border-[#9E9E9E] rounded mt-1 outline-none" />
                            </div>
                            ...
                            <div className={`mt-3 flex-grow rounded-lg ${selectedImageFiles.length > 1 ? "max-h-25 overflow-y-auto" : ""}`}>
                                ...
                                {selectedImageFiles.length === 0 ? (
                                    ...
                                    selectedImageFiles.map((file, index) => (
                                        <div key={index} className="flex items-center justify-between border border-[#9E9E9E] p-2 rounded mt-2">
                ...
                {showVideoPopup && (
                    <div className="fixed inset-0 bg-transparent backdrop-blur-sm flex justify-center items-center mt-12">
                        <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full relative h-[95%] flex flex-col">
                            ...
                            {/* Upload Box */}
                            <label htmlFor="videoFileInput" className="mt-3 border border-2 border-[#C684E0] bg-[#F4D9FF] p-6 text-center rounded-lg cursor-pointer">
                ...
                {showCodePopup && (
                    <div className="fixed inset-0 bg-transparent backdrop-blur-sm flex justify-center items-center mt-12">
                        <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full relative h-[95%] flex flex-col">
                            ...
                            {/* Upload Box */}
                            <label htmlFor="codeFileInput" className="mt-3 border border-[#376CFF] bg-[#DCE6FF] p-6 text-center rounded-lg cursor-pointer">
