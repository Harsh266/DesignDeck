...
const Dashboard = () => {
    ...
    const categoryStyles = {
        "Explore": "bg-blue-100 text-blue-500",
        "UI/UX": "bg-green-100 text-green-500",
        "Poster": "bg-red-100 text-red-500",
        "Logo Design": "bg-yellow-100 text-yellow-500",
        "App Design": "bg-purple-100 text-purple-500",
    };
                ...
                <div className="flex justify-center mt-6 gap-4">
                    {categories.map((cat) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeCategory === cat ? categoryStyles[cat] : "text-gray-600"}`}
                        >
                            {cat}
                        </button>
                    ))}
